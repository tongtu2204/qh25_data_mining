...
\midrule
Table 5 - D1 & \refcite{21}{21} & 960 & 62 & 1.022 & Gần đúng 20\% của Dataset 1, chưa cân bằng test \\
Table 5 - D1 & Our approach (a) & 960 & 62 & 1.022 & Cùng support với \refcite{21}{21}, chưa balancing trong tập đánh giá \\
...
\subsubsection{Đối chiếu với \refcite{21}{21} và hai cấu hình trong Table 5}
...
\centering
\scriptsize
\caption{Dataset 1: đối chiếu Table 5 với kết quả tái hiện và cải tiến của nhóm}
...
Bảng~\ref{tab:final_summary} chỉ tổng hợp các kết quả do nhóm thực nghiệm trên \textbf{cùng test split giữ nguyên phân bố lớp}. Kết quả công bố của tác giả không được đưa vào bảng này vì support và giao thức đánh giá không tương đương. Nhờ đó, mọi kết luận tăng/giảm dưới đây đều là so sánh trực tiếp và có cùng mẫu đánh giá.
