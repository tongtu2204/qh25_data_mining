\chapter{THẢO LUẬN}
Trong bài báo này, phương pháp đề xuất được kiểm thử trên hai tập dữ liệu. Các kết quả chính đã được mô tả trong phần Kết quả. Để so sánh chi tiết hơn với các công trình hiện có và xác định vị trí của phương pháp đề xuất, \textit{chúng tôi} bổ sung so sánh với các nghiên cứu liên quan. Cụ thể, Bảng~\ref{tab:studies} so sánh phương pháp của \textit{chúng tôi} với ba công trình trên Dataset 1.

\begin{table}[H]
\centering
\caption{So sánh các phương pháp dự đoán và kết quả trong nghiên cứu của \textit{chúng tôi} với các nghiên cứu khác}\label{tab:studies}
\resizebox{\textwidth}{!}{%
\begin{tabular}{p{2.2cm}p{5.0cm}p{4.2cm}p{3.2cm}p{4.8cm}}
\toprule
\textbf{Thuộc tính} & \textbf{\refcite{18}{18}} & \textbf{\refcite{33}{33}} & \textbf{\refcite{34}{34}} & \textbf{Phương pháp của \textit{chúng tôi}}\\
\midrule
