...
\newcommand{\SupervisorName}{GIẢNG VIÊN HƯỚNG DẪN}
...
\vspace*{2.2cm}
\end{center}
\noindent\hspace*{2.7cm}\textbf{Học phần:} \CourseName\\[1.1cm]
\noindent\hspace*{2.7cm}\textbf{Giảng viên hướng dẫn:} \SupervisorName
\vfill
\begin{center}
{\fontsize{15}{18}\selectfont\bfseries HÀ NỘI -- \ReportYear}
\end{center}
