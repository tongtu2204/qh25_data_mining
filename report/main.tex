...
% Giữ template chính của nhánh linh: Times New Roman 13pt, lề trái 3.5cm,
% phải 2cm, trên/dưới 2cm, giãn dòng 1.30.
...
% Giảm khoảng trắng và cho phép LaTeX đặt hình linh hoạt gần vị trí được tham chiếu.
...
% Hình mặc định được căn giữa, giới hạn cả chiều rộng và chiều cao.
% [htbp] tránh khoảng trắng lớn do ép mọi hình đứng đúng vị trí bằng [H].
...
% ==================== BÌA ====================
% Bố cục kế thừa từ nhánh linh; chỉ giữ một trang bìa đang sử dụng.
\begin{titlepage}
\thispagestyle{empty}
...
% ==================== PHẦN ĐẦU ====================
% Thứ tự front matter giữ theo nhánh linh: thông tin bài báo -> tóm tắt ->
% mục lục -> viết tắt -> danh mục hình -> danh mục bảng.
\frontmatter
\pagenumbering{roman}
\setcounter{page}{1}
