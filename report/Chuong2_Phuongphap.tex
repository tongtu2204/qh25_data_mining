...
Phân tích dữ liệu khám phá (EDA) \refcite{28}{28} được sử dụng để phân tích sơ bộ và xác định các vấn đề tiềm ẩn, chẳng hạn mất cân bằng lớp và dữ liệu thiếu, có thể ảnh hưởng tiêu cực đến mô hình.
...
Để diễn giải dự báo của mô hình, chúng tôi sử dụng phương pháp SHAP \refcite{30}{30}, ước lượng đóng góp của từng đặc trưng $j$ vào dự báo của từng mẫu $i$:
\[
