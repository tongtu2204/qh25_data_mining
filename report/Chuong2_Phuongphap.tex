...
Dưới đây \textit{chúng tôi} mô tả phương pháp đề xuất.
...
Khai phá dữ liệu (EDA) \refcite{28}{28} được sử dụng để phân tích sơ bộ và xác định các vấn đề tiềm ẩn, chẳng hạn mất cân bằng lớp và dữ liệu thiếu, có thể ảnh hưởng tiêu cực đến mô hình.
...
\paperfig[0.45\linewidth]{figures_original/fig-005.jpg}{Sơ đồ luồng của phương pháp đề xuất.\label{fig:flow}}
